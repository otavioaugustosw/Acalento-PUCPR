...
<aside id="sidebar" class="sidebar position-fixed top-0 start-0 bottom-0 d-none d-md-block" style="width: 250px">
    <div class="flex-shrink-0 p-3 menu-lateral h-100" style="width: 280px;">
        <a class="d-flex flex-column align-items-start pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
            <div class="logo-container">
                <img src="../../../PROJETO/assets/logo/Acalento_logo_claro.svg" alt="Logo Acalento Claro" class=" logo logo-tema-claro">
            </div>
            <span class="fs-3 fw-semibold saudacao mt-5">Olá...</span>
        </a>
        <!-- sidebar navigation -->
